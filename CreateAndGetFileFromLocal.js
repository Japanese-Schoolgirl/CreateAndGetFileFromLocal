...
// "CreateAndGetFile('.txt', 'script', (el) => { CreateAndGetFile('.html', 'iframe'); });", "CreateAndGetFile('.txt', 'text', undefined, false, 'readAsText', undefined, 'innerText');", "CreateAndGetFile('.txt', 'iframe');", "CreateAndGetFile('.png, .jpg', 'img', (el) => { window['VarWithFile'] = { base64: el.src, blob: el.objectURL }; alert(`Blob link: ${VarWithFile.blob} \nAnd base64 link: ${VarWithFile.base64}`) }, true, undefined, undefined, 'src');", etc. //
